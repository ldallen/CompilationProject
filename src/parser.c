...
static const yytype_uint16 yyrline[] =
{
     ...
     220,   236,   237,   249,   252,   275,   318,   321,   397,   400,
     475,   553,   556,   644,   732,   819,   906,   993,  1083,  1138,
    1168,  1174,  1178,  1179,  1190,  1191,  1192,  1196,  1217,  1245,
    1263,  1297,  1331,  1357,  1386,  1387,  1398,  1402,  1403,  1404,
    1405,  1406,  1410,  1413,  1416,  1426,  1427,  1438,  1439,  1450,
    1451,  1461,  1474,  1493,  1509,  1527,  1546,  1550,  1559,  1560,
    1564,  1565,  1569
};
#endif
...
#line 1083 "parser.y"
  ...
  {
	 if((yyvsp[(3) - (3)].t).element_type == local_identifier.element_type && (yyvsp[(3) - (3)].t).kind == -1) // egalite entre pointeurs
	 {
	    std::stringstream s;
		s << *(yyvsp[(3) - (3)].t).code;
		s << "popq %rax\n";
...
#line 1550 "parser.y"
    {
  std::stringstream s;
  s << "popq %rax\nmovq %rax, " << -(yyvsp[(2) - (3)].t).addre << "(%rbp)\n";
  (yyval.t).code = new std::string(s.str());
  vec.push_back((yyval.t).code);
 }
    break;
